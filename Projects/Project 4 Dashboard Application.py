...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type',
                                  ...
                                  labels={'Advertising_Expenditure': 'Total Expenditure'}))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        average_sales_by_unemployment = data.groupby(['Unemployment_Rate', 'Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = px.bar(average_sales_by_unemployment, x='Unemployment_Rate', y='Automobile_Sales', color='Vehicle_Type',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        mts= data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(
                figure=px.line(mts, 
                x='Month',
                y='Automobile_Sales',
